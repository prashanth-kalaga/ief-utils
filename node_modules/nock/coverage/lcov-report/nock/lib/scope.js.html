...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">93.19% <small>(342 / 367)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">83.82% <small>(202 / 241)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">89.83% <small>(53 / 59)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">93.15% <small>(340 / 365)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
844
845
846</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
    ...
    if (!nockDef.response) {
      ...
      response = _.isString(nockDef.response) ? tryJsonParse(nockDef.response) : <span class="branch-1 cbranch-no" title="branch not covered" >nockDef.response;</span>
    }
&nbsp;
    var nock;
...
<span class="cstat-no" title="statement not covered" >        return "*";</span>
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (nockDef.filteringRequestBody) {
<span class="cstat-no" title="statement not covered" >        nock.filteringRequestBody(nockDef.filteringRequestBody);</span>
      }
